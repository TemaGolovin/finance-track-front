...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'border-none w-full bg-background group/calendar p-3 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          ...
          return <ChevronDownIcon className={cn('size-10', className)} {...props} />;
        },
